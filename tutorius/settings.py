"""
Django settings for tutorius project.
...
SECRET_KEY = 'y(adg5m%fyk_vdvpt3)#097^+k47fa=s!@knu_0mzhxanfwxf_'
...
WSGI_APPLICATION = 'tutorius.wsgi.application'
